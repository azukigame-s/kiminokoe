...
7. スキップ機能（早歩き）
8. トロフィーシステム（軌跡画面、リセット機能）
9. シーン管理（タイトル/セーブ情報/設定/軌跡/名前入力/ゲーム画面）
10. 設定システム（テキスト速度、音量、ウィンドウモード、起動時自動適用）
11. ポーズメニュー（一息）
12. 足跡（テキストログ/バックログ）
13. プレイ時間計測（ゲーム中に計測、オートセーブに含む）
14. セーブ情報画面（つづきからはじめる/はじめからはじめる/データリセット）
15. セーブシステム（ワンセーブデータ方式、オートセーブ、つづきから/はじめから/データリセット）
